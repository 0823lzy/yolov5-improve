...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "allpt/yolov5s.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default=ROOT / "models/yolov5s+RepNCSPELAN4.yaml", help="model.yaml path")
